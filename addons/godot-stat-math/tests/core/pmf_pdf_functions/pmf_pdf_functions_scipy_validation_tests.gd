# res://addons/godot-stat-math/tests/core/pmf_pdf_functions/pmf_pdf_functions_scipy_validation_tests.gd
class_name PmfPdfFunctionsScipyValidationTests extends GdUnitTestSuite
