# res://addons/godot-stat-math/tests/core/pmf_pdf_functions/pmf_pdf_functions_mathematical_property_tests.gd
class_name PmfPdfFunctionsMathematicalPropertyTests extends GdUnitTestSuite
