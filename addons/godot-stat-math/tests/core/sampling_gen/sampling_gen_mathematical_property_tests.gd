# res://addons/godot-stat-math/tests/core/sampling_gen/sampling_gen_mathematical_property_tests.gd
class_name SamplingGenMathematicalPropertyTests extends GdUnitTestSuite
