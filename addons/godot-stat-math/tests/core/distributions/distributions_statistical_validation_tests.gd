# res://addons/godot-stat-math/tests/core/distributions/distributions_statistical_validation_tests.gd
class_name DistributionsStatisticalValidationTests extends GdUnitTestSuite
