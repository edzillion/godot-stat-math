# res://addons/godot-stat-math/tests/core/distributions/mathematical_property_test.gd
class_name DistributionsMathematicalPropertyTest extends GdUnitTestSuite
