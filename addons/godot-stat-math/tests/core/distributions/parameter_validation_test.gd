# res://addons/godot-stat-math/tests/core/distributions/parameter_validation_test.gd
class_name DistributionsParameterValidationTest extends GdUnitTestSuite
