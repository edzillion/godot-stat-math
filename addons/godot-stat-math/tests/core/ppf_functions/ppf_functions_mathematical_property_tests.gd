# res://addons/godot-stat-math/tests/core/ppf_functions/ppf_functions_mathematical_property_tests.gd
class_name PpfFunctionsMathematicalPropertyTests extends GdUnitTestSuite
