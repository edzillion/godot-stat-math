# res://addons/godot-stat-math/tests/core/ppf_functions/ppf_functions_scipy_validation_tests.gd
class_name PpfFunctionsScipyValidationTests extends GdUnitTestSuite
