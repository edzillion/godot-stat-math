# res://addons/godot-stat-math/tests/core/ppf_functions/ppf_functions_parameter_validation_tests.gd
class_name PpfFunctionsParameterValidationTests extends GdUnitTestSuite
