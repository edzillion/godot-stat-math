# res://addons/godot-stat-math/tests/core/basic_stats/basic_stats_parameter_validation_tests.gd
class_name BasicStatsParameterValidationTests extends GdUnitTestSuite
