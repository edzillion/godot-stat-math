# res://addons/godot-stat-math/tests/core/error_functions/error_functions_scipy_validation_tests.gd
class_name ErrorFunctionsScipyValidationTests extends GdUnitTestSuite
