# res://addons/godot-stat-math/tests/core/error_functions/error_functions_parameter_validation_tests.gd
class_name ErrorFunctionsParameterValidationTests extends GdUnitTestSuite
