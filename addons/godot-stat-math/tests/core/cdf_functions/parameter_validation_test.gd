# res://addons/godot-stat-math/tests/core/cdf_functions/parameter_validation_test.gd
class_name CdfFunctionsParameterValidationTest extends GdUnitTestSuite
