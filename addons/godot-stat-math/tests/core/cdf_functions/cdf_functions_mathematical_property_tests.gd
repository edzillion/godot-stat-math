# res://addons/godot-stat-math/tests/core/cdf_functions/cdf_functions_mathematical_property_tests.gd
class_name CdfFunctionsMathematicalPropertyTests extends GdUnitTestSuite
